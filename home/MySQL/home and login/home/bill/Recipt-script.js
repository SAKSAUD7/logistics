...
function exportReceipts() {
    ...
    csvContent += "Slip Number,Date,Consignee Name,Payment Type,Amount\n";

    receipts.forEach(receipt => {
        csvContent += `${receipt.slipNumber},${receipt.date},${receipt.consigneeName},${receipt.paymentType},${receipt.amount}\n`;
    });
